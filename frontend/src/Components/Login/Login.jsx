      ...
      <div className={Style.left_section}>
        ...
        <form>
          <div className={Style.input_div}>
            ...
            <input type="text" placeholder="email / password" id="email/phonenumber" />
          </div>
          <div className={Style.input_div}>
        ...
        <div className={Style.Google_authentication}>
          ...
          <button><svg width="28" height="28" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
