...
const Chat = ({ existingConverstaionId, HandleRead }) => {
    ...
    const handleMessage = (e) => {
        ...
        try {
            authInstance.post("/api/user/chat/addmessage", NewMessage).then((res) => {
                SetText({
                    text: ""
                })
            }).catch((err) => {
                                    ...
                                    <div className={Style.offerbox}>
                                        <div className={Style.left}>
                                            ...
                                            <button
                                                ...
                                                onClick={(e) => handleMessage(e)}> <RiSendPlaneFill />
                                            </button>
                                        </div>
                                        <div className={Style.right}>
                                            <span onClick={() => { SetActive(!Active) }} ><FaChevronDown /></span>
                                        </div>
                                    </div>
                                    ...
                                    <form action="" onSubmit={(e) => handleMessage(e)}>
                                        ...
                                        <div className={Style.typebox}>
                                            <input type="text"
                                                ...
                                                value={Text.text}
                                            />
                                            <span className={Style.offerbtn} disabled onClick={() => {
                                                SetText({ ...Text, text: "" })
                                                SetActive(!Active)
                                            }
                                            } ><OfflineBoltRounded /> <span> Make Offer </span> </span>
                                            <button className={Text.text === "" ? Style.buttonInactive : ""} disabled={Text.text === "" ? true : false}><RiSendPlaneFill /></button>
                                        </div>
                                    </form>
                                }
